...
@mcp.tool()
async def api_create_connectionstargeting(
...
@mcp.tool()
async def api_delete_connectionstargeting(
    connectionstargeting_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_get_connectionstargeting(
    connectionstargeting_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_update_connectionstargeting(
    connectionstargeting_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
