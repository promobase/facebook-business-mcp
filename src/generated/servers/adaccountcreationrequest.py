...
@mcp.tool()
async def api_create_adaccountcreationrequest(
...
@mcp.tool()
async def api_delete_adaccountcreationrequest(
    adaccountcreationrequest_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_get_adaccountcreationrequest(
    adaccountcreationrequest_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_update_adaccountcreationrequest(
    adaccountcreationrequest_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
