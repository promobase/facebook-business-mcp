...
@mcp.tool()
async def create_businessproject(
    object_id: str,
    parent_id: Optional[Any] = None,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
    result = BusinessProject(fbid=object_id).api_create(
        parent_id=parent_id,
        fields=fields,
        params=params,
    )
...
async def delete_businessproject(
    ...
    result = BusinessProject(fbid=object_id).api_delete(
        fields=fields,
        params=params,
    )
...
@mcp.tool()
async def update_businessproject(
    object_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
    result = BusinessProject(fbid=object_id).api_update(
        fields=fields,
        params=params,
    )
