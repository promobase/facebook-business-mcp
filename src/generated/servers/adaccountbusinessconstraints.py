...
@mcp.tool()
async def api_create_adaccountbusinessconstraints(
...
@mcp.tool()
async def api_delete_adaccountbusinessconstraints(
    adaccountbusinessconstraints_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_get_adaccountbusinessconstraints(
    adaccountbusinessconstraints_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_update_adaccountbusinessconstraints(
    adaccountbusinessconstraints_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
