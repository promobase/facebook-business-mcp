...
@mcp.tool()
async def api_create_apprequestformerrecipient(
...
@mcp.tool()
async def api_delete_apprequestformerrecipient(
    apprequestformerrecipient_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_get_apprequestformerrecipient(
    apprequestformerrecipient_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_update_apprequestformerrecipient(
    apprequestformerrecipient_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
