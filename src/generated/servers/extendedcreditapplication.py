...
@mcp.tool()
async def api_create_extendedcreditapplication(
...
@mcp.tool()
async def api_delete_extendedcreditapplication(
    extendedcreditapplication_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_get_extendedcreditapplication(
    extendedcreditapplication_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_update_extendedcreditapplication(
    extendedcreditapplication_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
