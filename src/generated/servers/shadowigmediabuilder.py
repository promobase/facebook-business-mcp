...
@mcp.tool()
async def api_create_shadowigmediabuilder(
...
@mcp.tool()
async def api_delete_shadowigmediabuilder(
    shadowigmediabuilder_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_get_shadowigmediabuilder(
    shadowigmediabuilder_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_update_shadowigmediabuilder(
    shadowigmediabuilder_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
