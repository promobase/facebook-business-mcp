...
@mcp.tool()
async def delete_businesscreativefolder(
    object_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
    result = BusinessCreativeFolder(fbid=object_id).api_delete(
        fields=fields,
        params=params,
    )
...
@mcp.tool()
async def update_businesscreativefolder(
    object_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
    result = BusinessCreativeFolder(fbid=object_id).api_update(
        fields=fields,
        params=params,
    )
