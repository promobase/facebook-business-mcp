...
@mcp.tool()
async def api_create_educationexperience(
...
@mcp.tool()
async def api_delete_educationexperience(
    educationexperience_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_get_educationexperience(
    educationexperience_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_update_educationexperience(
    educationexperience_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
