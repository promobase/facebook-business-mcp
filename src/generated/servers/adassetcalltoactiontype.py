...
@mcp.tool()
async def api_create_adassetcalltoactiontype(
...
@mcp.tool()
async def api_delete_adassetcalltoactiontype(
    adassetcalltoactiontype_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_get_adassetcalltoactiontype(
    adassetcalltoactiontype_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_update_adassetcalltoactiontype(
    adassetcalltoactiontype_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
