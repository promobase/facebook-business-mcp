...
@mcp.tool()
async def api_create_productfeedschedule(
...
@mcp.tool()
async def api_delete_productfeedschedule(
    productfeedschedule_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_get_productfeedschedule(
    productfeedschedule_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
...
@mcp.tool()
async def api_update_productfeedschedule(
    productfeedschedule_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
