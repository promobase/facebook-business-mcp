...
@mcp.tool()
async def create_productcataloglocalizationsettings(
    object_id: str,
    parent_id: Optional[Any] = None,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
    result = ProductCatalogLocalizationSettings(fbid=object_id).api_create(
        parent_id=parent_id,
        fields=fields,
        params=params,
    )
...
@mcp.tool()
async def delete_productcataloglocalizationsettings(
    object_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
    result = ProductCatalogLocalizationSettings(fbid=object_id).api_delete(
        fields=fields,
        params=params,
    )
...
@mcp.tool()
async def update_productcataloglocalizationsettings(
    object_id: str,
    fields: list[str] = [],
    params: dict[str, Any] = {},
) -> dict[str, Any]:
    result = ProductCatalogLocalizationSettings(fbid=object_id).api_update(
        fields=fields,
        params=params,
    )
