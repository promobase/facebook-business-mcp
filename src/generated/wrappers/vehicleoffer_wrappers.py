...
class VehicleOfferWrappers:
    """Type-safe wrapper functions for VehicleOffer API methods."""

    @staticmethod
    def get_override_details(
        obj: VehicleOffer,
        params: Optional[VehicleOfferGetOverrideDetailsParams] = None,
        fields: Optional[list[OverrideDetailsField]] = None,
    ) -> TypedCursor[OverrideDetailsFields]:
        """
        Type-safe wrapper for VehicleOffer.get_override_details().
