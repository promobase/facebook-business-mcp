...
class LocalServiceBusinessWrappers:
    """Type-safe wrapper functions for LocalServiceBusiness API methods."""

    @staticmethod
    def get_override_details(
        obj: LocalServiceBusiness,
        params: Optional[LocalServiceBusinessGetOverrideDetailsParams] = None,
        fields: Optional[list[OverrideDetailsField]] = None,
    ) -> TypedCursor[OverrideDetailsFields]:
        """
        Type-safe wrapper for LocalServiceBusiness.get_override_details().
