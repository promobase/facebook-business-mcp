...
class FlightWrappers:
    """Type-safe wrapper functions for Flight API methods."""

    @staticmethod
    def get_override_details(
        obj: Flight,
        params: Optional[FlightGetOverrideDetailsParams] = None,
        fields: Optional[list[OverrideDetailsField]] = None,
    ) -> TypedCursor[OverrideDetailsFields]:
        """
        Type-safe wrapper for Flight.get_override_details().
