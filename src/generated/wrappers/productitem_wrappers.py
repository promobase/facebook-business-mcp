...
class ProductItemWrappers:
    """Type-safe wrapper functions for ProductItem API methods."""

    @staticmethod
    def get_override_details(
        obj: ProductItem,
        params: Optional[ProductItemGetOverrideDetailsParams] = None,
        fields: Optional[list[OverrideDetailsField]] = None,
    ) -> TypedCursor[OverrideDetailsFields]:
        """
        Type-safe wrapper for ProductItem.get_override_details().
