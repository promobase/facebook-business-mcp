...
class MediaTitleWrappers:
    """Type-safe wrapper functions for MediaTitle API methods."""

    @staticmethod
    def get_override_details(
        obj: MediaTitle,
        params: Optional[MediaTitleGetOverrideDetailsParams] = None,
        fields: Optional[list[OverrideDetailsField]] = None,
    ) -> TypedCursor[OverrideDetailsFields]:
        """
        Type-safe wrapper for MediaTitle.get_override_details().
