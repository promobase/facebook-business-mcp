...
class VehicleWrappers:
    """Type-safe wrapper functions for Vehicle API methods."""

    @staticmethod
    def get_override_details(
        obj: Vehicle,
        params: Optional[VehicleGetOverrideDetailsParams] = None,
        fields: Optional[list[OverrideDetailsField]] = None,
    ) -> TypedCursor[OverrideDetailsFields]:
        """
        Type-safe wrapper for Vehicle.get_override_details().
