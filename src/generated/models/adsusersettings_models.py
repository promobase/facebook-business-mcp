...
class AdsUserSettingsFields(BaseModel):
    ...
    ads_cs_catalog_opt_out_timestamp: list[dict[str, int]] | None = Field(None, alias="ads_cs_catalog_opt_out_timestamp")
    ads_tool_visits: list[dict[str, Any]] | None = Field(None, alias="ads_tool_visits")
    aplusc_carousel_cda_opt_in_status: str | None = Field(None, alias="aplusc_carousel_cda_opt_in_status")
    aplusc_carousel_inline_comment_opt_in_status: str | None = Field(None, alias="aplusc_carousel_inline_comment_opt_in_status")
    aplusc_enhance_cta_opt_in_status: str | None = Field(None, alias="aplusc_enhance_cta_opt_in_status")
    aplusc_epa_opt_in_status: str | None = Field(None, alias="aplusc_epa_opt_in_status")
    aplusc_local_store_extension_opt_in_status: str | None = Field(None, alias="aplusc_local_store_extension_opt_in_status")
    aplusc_opt_out_friction: list[str] | None = Field(None, alias="aplusc_opt_out_friction")
    aplusc_videofilter_opt_in_status: str | None = Field(None, alias="aplusc_videofilter_opt_in_status")
    aplusc_videouncrop_opt_in_status: str | None = Field(None, alias="aplusc_videouncrop_opt_in_status")
    ...
    blended_ads_creation_defaulting_opt_in_status: str | None = Field(None, alias="blended_ads_creation_defaulting_opt_in_status")
    blended_ads_creation_defaulting_opt_out_campaign_group_ids: list[int] | None = Field(None, alias="blended_ads_creation_defaulting_opt_out_campaign_group_ids")
    bookmarked_pages: list[dict[str, Any]] | None = Field(None, alias="bookmarked_pages")
    campaign_group_name_template: dict[str, Any] | None = Field(None, alias="campaign_group_name_template")
    campaign_name_template: dict[str, Any] | None = Field(None, alias="campaign_name_template")
    carousel_to_video_opt_in_status: str | None = Field(None, alias="carousel_to_video_opt_in_status")
    connected_sources_catalog_opt_in_status: str | None = Field(None, alias="connected_sources_catalog_opt_in_status")
    ...
    dynamic_partnership_ads_opt_in_status: str | None = Field(None, alias="dynamic_partnership_ads_opt_in_status")
    enhance_cta_text_extraction_opt_in_status: str | None = Field(None, alias="enhance_cta_text_extraction_opt_in_status")
    ...
    image_background_generation_opt_in_status: str | None = Field(None, alias="image_background_generation_opt_in_status")
    image_brightness_and_contrast_opt_in_status: str | None = Field(None, alias="image_brightness_and_contrast_opt_in_status")
    ...
    is_se_removal_guidance_dismissed: bool | None = Field(None, alias="is_se_removal_guidance_dismissed")
    ...
    metadata_brand_kit_opt_in_status: str | None = Field(None, alias="metadata_brand_kit_opt_in_status")
    music_on_reels_opt_in: list[dict[str, str]] | None = Field(None, alias="music_on_reels_opt_in")
    muted_cbo_midflight_education_messages: list[str] | None = Field(None, alias="muted_cbo_midflight_education_messages")
    onsite_destination_optimization_opt_in: str | None = Field(None, alias="onsite_destination_optimization_opt_in")
    ...
    placement_group_square_opt_in_status: str | None = Field(None, alias="placement_group_square_opt_in_status")
    placement_group_vertical_opt_in_status: str | None = Field(None, alias="placement_group_vertical_opt_in_status")
    previously_seen_recommendations: list[str] | None = Field(None, alias="previously_seen_recommendations")
    ...
    saoff_published_l2_conv_loc_seen: str | None = Field(None, alias="saoff_published_l2_conv_loc_seen")
    saon_migr_l1_seen_status: str | None = Field(None, alias="saon_migr_l1_seen_status")
    selected_ad_account: dict[str, Any] | None = Field(None, alias="selected_ad_account")
    selected_comparison_timerange: dict[str, Any] | None = Field(None, alias="selected_comparison_timerange")
    ...
    selected_page: dict[str, Any] | None = Field(None, alias="selected_page")
    ...
    should_export_filter_empty_cols: str | None = Field(None, alias="should_export_filter_empty_cols")
    should_export_rows_without_unsupported_feature: str | None = Field(None, alias="should_export_rows_without_unsupported_feature")
    should_not_auto_expand_tree_table: bool | None = Field(None, alias="should_not_auto_expand_tree_table")
    should_not_show_cbo_campaign_toggle_off_confirmation_message: bool | None = Field(None, alias="should_not_show_cbo_campaign_toggle_off_confirmation_message")
    should_not_show_publish_message_on_editor_close: bool | None = Field(None, alias="should_not_show_publish_message_on_editor_close")
    show_original_videos_opt_in: str | None = Field(None, alias="show_original_videos_opt_in")
    static_ad_product_extensions_opt_in: str | None = Field(None, alias="static_ad_product_extensions_opt_in")
    sticky_setting_after_default_on: str | None = Field(None, alias="sticky_setting_after_default_on")
    syd_campaign_trends_metric: str | None = Field(None, alias="syd_campaign_trends_metric")
    text_optimizations_text_extraction_opt_in_status: str | None = Field(None, alias="text_optimizations_text_extraction_opt_in_status")
    text_translation_opt_in_status: str | None = Field(None, alias="text_translation_opt_in_status")
    text_variations_sticky_opt_in_status: str | None = Field(None, alias="text_variations_sticky_opt_in_status")
