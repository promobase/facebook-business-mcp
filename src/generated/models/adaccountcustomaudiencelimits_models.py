...
AdAccountCustomAudienceLimitsField = Literal["audience_update_quota_in_total", "audience_update_quota_left", "has_hit_audience_update_limit", "next_audience_update_available_time", "rate_limit_reset_time"]
...
class AdAccountCustomAudienceLimitsFields(BaseModel):
    ...
    next_audience_update_available_time: str | None = Field(None, alias="next_audience_update_available_time")
