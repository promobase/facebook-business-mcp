...
class AdgroupPlacementSpecificReviewFeedbackFields(BaseModel):
    ...
    ads_conversion_experiences: dict[str, str] | None = Field(None, alias="ads_conversion_experiences")
    ...
    facebook_pages_live_shopping: dict[str, str] | None = Field(None, alias="facebook_pages_live_shopping")
