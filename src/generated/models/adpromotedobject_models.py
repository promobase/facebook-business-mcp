...
class AdPromotedObjectCustomEventType(str, Enum):
    """Enum for AdPromotedObject.CustomEventType."""
...
class AdPromotedObjectLeadAdsCustomEventType(str, Enum):
    """Enum for AdPromotedObject.LeadAdsCustomEventType."""
    ACHIEVEMENT_UNLOCKED = "ACHIEVEMENT_UNLOCKED"
    ADD_PAYMENT_INFO = "ADD_PAYMENT_INFO"
    ADD_TO_CART = "ADD_TO_CART"
    ADD_TO_WISHLIST = "ADD_TO_WISHLIST"
...
class AdPromotedObjectFields(BaseModel):
    ...
    lead_ads_custom_event_type: dict[str, Any] | None = Field(None, alias="lead_ads_custom_event_type")
    lead_ads_form_event_source_type: str | None = Field(None, alias="lead_ads_form_event_source_type")
    lead_ads_offsite_conversion_type: str | None = Field(None, alias="lead_ads_offsite_conversion_type")
    ...
    place_page_set: dict[str, Any] | None = Field(None, alias="place_page_set")
    ...
    product_set: dict[str, Any] | None = Field(None, alias="product_set")
