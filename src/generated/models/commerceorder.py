...
class CommerceOrderFields(BaseModel):
    ...
    buyer_details: dict[str, Any] = Field(None, alias="buyer_details")
    channel: str = Field(None, alias="channel")
    contains_bopis_items: bool = Field(None, alias="contains_bopis_items")
    created: str = Field(None, alias="created")
    estimated_payment_details: dict[str, Any] = Field(None, alias="estimated_payment_details")
    id: str = Field(None, alias="id")
    is_group_buy: bool = Field(None, alias="is_group_buy")
    is_test_order: bool = Field(None, alias="is_test_order")
    last_updated: str = Field(None, alias="last_updated")
    merchant_order_id: str = Field(None, alias="merchant_order_id")
    order_status: dict[str, Any] = Field(None, alias="order_status")
    pre_order_details: dict[str, Any] = Field(None, alias="pre_order_details")
    selected_shipping_option: dict[str, Any] = Field(None, alias="selected_shipping_option")
    ship_by_date: str = Field(None, alias="ship_by_date")
...
class CommerceOrderCreateRefundParams(BaseModel):
    ...
    idempotency_key: str | None = Field(None, description="idempotency_key parameter")
    items: list[dict[str, Any]] | None = Field(None, description="items parameter")
    reason_code: commerceorderrefunds_reason_code_enum_param | None = Field(
        None, description="reason_code parameter"
    )
...
class CommerceOrderGetReturnsParams(BaseModel):
    ...
    statuses: list[commerceorderreturns_statuses_enum_param] | None = Field(
