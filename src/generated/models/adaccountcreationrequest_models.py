...
class AdAccountCreationRequestFields(BaseModel):
    ...
    legal_entity_name_in_local_language: str | None = Field(None, alias="legal_entity_name_in_local_language")
    ...
    request_change_reasons: list[dict[str, Any]] | None = Field(None, alias="request_change_reasons")
