...
class AdAccountUserSettingsFields(BaseModel):
    ...
    acf_should_opt_out_video_adjustments: bool | None = Field(None, alias="acf_should_opt_out_video_adjustments")
    ...
    ads_manager_footer_row_toast_impressions: int | None = Field(None, alias="ads_manager_footer_row_toast_impressions")
    ...
    conditional_formatting_rules: list[str] | None = Field(None, alias="conditional_formatting_rules")
    default_account_overview_agegender_metrics: list[str] | None = Field(None, alias="default_account_overview_agegender_metrics")
    default_account_overview_location_metrics: list[str] | None = Field(None, alias="default_account_overview_location_metrics")
    default_account_overview_metrics: list[str] | None = Field(None, alias="default_account_overview_metrics")
    default_account_overview_time_metrics: list[str] | None = Field(None, alias="default_account_overview_time_metrics")
    ...
    export_deleted_items_with_delivery: bool | None = Field(None, alias="export_deleted_items_with_delivery")
    export_summary_row: bool | None = Field(None, alias="export_summary_row")
    had_delivery_quick_view_created: bool | None = Field(None, alias="had_delivery_quick_view_created")
    has_seen_groups_column_flexing_experience: bool | None = Field(None, alias="has_seen_groups_column_flexing_experience")
    has_seen_instagram_column_flexing_experience: bool | None = Field(None, alias="has_seen_instagram_column_flexing_experience")
    has_seen_leads_column_flexing_experience: bool | None = Field(None, alias="has_seen_leads_column_flexing_experience")
    has_seen_shops_ads_metrics_onboarding_tour: bool | None = Field(None, alias="has_seen_shops_ads_metrics_onboarding_tour")
    has_seen_shops_column_flexing_experience: bool | None = Field(None, alias="has_seen_shops_column_flexing_experience")
    hidden_optimization_tips: list[dict[str, bool]] | None = Field(None, alias="hidden_optimization_tips")
    high_performing_quick_view_created: bool | None = Field(None, alias="high_performing_quick_view_created")
    id: str | None = Field(None, alias="id")
    is_3p_auth_setting_set: bool | None = Field(None, alias="is_3p_auth_setting_set")
    is_ads_manager_footer_row_preference_set: bool | None = Field(None, alias="is_ads_manager_footer_row_preference_set")
    is_ads_manager_footer_row_shown: bool | None = Field(None, alias="is_ads_manager_footer_row_shown")
    ...
    saip_advertiser_setup_optimisation_guidance_overall_state: str | None = Field(None, alias="saip_advertiser_setup_optimisation_guidance_overall_state")
    saip_advertiser_setup_optimisation_guidance_state: list[dict[str, str]] | None = Field(None, alias="saip_advertiser_setup_optimisation_guidance_state")
    shops_ads_metrics_onboarding_tour_close_count: int | None = Field(None, alias="shops_ads_metrics_onboarding_tour_close_count")
    shops_ads_metrics_onboarding_tour_last_action_time: datetime | None = Field(None, alias="shops_ads_metrics_onboarding_tour_last_action_time")
    should_default_image_auto_crop: bool | None = Field(None, alias="should_default_image_auto_crop")
    should_default_image_auto_crop_for_tail: bool | None = Field(None, alias="should_default_image_auto_crop_for_tail")
    should_default_image_auto_crop_optimization: bool | None = Field(None, alias="should_default_image_auto_crop_optimization")
    should_default_image_dof_toggle: bool | None = Field(None, alias="should_default_image_dof_toggle")
    should_default_image_lpp_ads_to_square: bool | None = Field(None, alias="should_default_image_lpp_ads_to_square")
    should_default_instagram_profile_card_optimization: bool | None = Field(None, alias="should_default_instagram_profile_card_optimization")
    should_default_text_swapping_optimization: bool | None = Field(None, alias="should_default_text_swapping_optimization")
    should_logout_of_3p_sourcing: bool | None = Field(None, alias="should_logout_of_3p_sourcing")
    should_show_shops_ads_metrics_onboarding_tour: bool | None = Field(None, alias="should_show_shops_ads_metrics_onboarding_tour")
    show_archived_data: bool | None = Field(None, alias="show_archived_data")
    show_text_variation_nux_tooltip: bool | None = Field(None, alias="show_text_variation_nux_tooltip")
    syd_campaign_trends_activemetric: str | None = Field(None, alias="syd_campaign_trends_activemetric")
    syd_campaign_trends_attribution: str | None = Field(None, alias="syd_campaign_trends_attribution")
    syd_campaign_trends_metrics: list[str] | None = Field(None, alias="syd_campaign_trends_metrics")
    syd_campaign_trends_objective: dict[str, Any] | None = Field(None, alias="syd_campaign_trends_objective")
    ...
    text_variations_opt_in_out_ts: datetime | None = Field(None, alias="text_variations_opt_in_out_ts")
