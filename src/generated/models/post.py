...
class PostGetCommentsParams(BaseModel):
    ...
    filter: postcomments_filter_enum_param | None = Field(None, description="filter parameter")
    live_filter: postcomments_live_filter_enum_param | None = Field(
        None, description="live_filter parameter"
    )
    order: postcomments_order_enum_param | None = Field(None, description="order parameter")
...
class PostCreateCommentParams(BaseModel):
    ...
    comment_privacy_value: postcomments_comment_privacy_value_enum_param | None = Field(
...
class PostGetInsightsParams(BaseModel):
    ...
    model_config = ConfigDict(extra="forbid")
    date_preset: postinsights_date_preset_enum_param | None = Field(
        None, description="date_preset parameter"
    )
    metric: list[dict[str, Any]] | None = Field(None, description="metric parameter")
    period: postinsights_period_enum_param | None = Field(None, description="period parameter")
    since: datetime | None = Field(None, description="since parameter")
...
class PostGetReactionsParams(BaseModel):
    ...
    model_config = ConfigDict(extra="forbid")
    type: postreactions_type_enum_param | None = Field(None, description="type parameter")
