...
class PostBackdatedTimeGranularity(str, Enum):
    """Enum for Post.BackdatedTimeGranularity."""
...
class PostFormatting(str, Enum):
    """Enum for Post.Formatting."""

    MARKDOWN = "MARKDOWN"
    PLAINTEXT = "PLAINTEXT"


class PostPlaceAttachmentSetting(str, Enum):
    """Enum for Post.PlaceAttachmentSetting."""

    VALUE_1 = "1"
    VALUE_2 = "2"


class PostPostSurfacesBlacklist(str, Enum):
    """Enum for Post.PostSurfacesBlacklist."""
...
class PostPostingToRedspace(str, Enum):
    """Enum for Post.PostingToRedspace."""

    DISABLED = "disabled"
    ENABLED = "enabled"


class PostTargetSurface(str, Enum):
    """Enum for Post.TargetSurface."""

    STORY = "STORY"
    TIMELINE = "TIMELINE"


class PostUnpublishedContentType(str, Enum):
    """Enum for Post.UnpublishedContentType."""
...
class PostFeedStoryVisibility(str, Enum):
    """Enum for Post.FeedStoryVisibility."""

    HIDDEN = "hidden"
    VISIBLE = "visible"


class PostTimelineVisibility(str, Enum):
    """Enum for Post.TimelineVisibility."""
