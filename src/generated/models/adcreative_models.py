...
class AdCreativeFields(BaseModel):
    ...
    ad_disclaimer_spec: dict[str, Any] | None = Field(None, alias="ad_disclaimer_spec")
    adlabels: list[dict[str, Any]] | None = Field(None, alias="adlabels")
    applink_treatment: str | None = Field(None, alias="applink_treatment")
    asset_feed_spec: dict[str, Any] | None = Field(None, alias="asset_feed_spec")
    ...
    facebook_branded_content: dict[str, Any] | None = Field(None, alias="facebook_branded_content")
    ...
    object_story_spec: dict[str, Any] | None = Field(None, alias="object_story_spec")
    ...
    portrait_customizations: dict[str, Any] | None = Field(None, alias="portrait_customizations")
    ...
    template_url_spec: dict[str, Any] | None = Field(None, alias="template_url_spec")
