...
class AdCreativeDegreesOfFreedomSpecFields(BaseModel):
    ...
    creative_features_spec: dict[str, Any] | None = Field(None, alias="creative_features_spec")
    ...
    multi_media_transformation_type: str | None = Field(None, alias="multi_media_transformation_type")
    stories_transformation_types: list[str] | None = Field(None, alias="stories_transformation_types")
