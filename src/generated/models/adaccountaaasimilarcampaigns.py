...
class AdAccountAAASimilarCampaignsFields(BaseModel):
    ...
    similar_campaign_limit: int = Field(None, alias="similar_campaign_limit")
    similar_campaigns_info: list[dict[str, dict[str, Any]]] = Field(
        None, alias="similar_campaigns_info"
    )
    used_campaign_slots: int = Field(None, alias="used_campaign_slots")
