...
class AdAccountAdVolumeFields(BaseModel):
    ...
    ad_limit_scope_business: dict[str, Any] | None = Field(None, alias="ad_limit_scope_business")
    ad_limit_scope_business_manager_id: str | None = Field(None, alias="ad_limit_scope_business_manager_id")
    ...
    ads_running_or_in_review_count_subject_to_limit_set_by_page: int | None = Field(None, alias="ads_running_or_in_review_count_subject_to_limit_set_by_page")
    current_account_ads_running_or_in_review_count: int | None = Field(None, alias="current_account_ads_running_or_in_review_count")
    future_limit_activation_date: str | None = Field(None, alias="future_limit_activation_date")
    future_limit_on_ads_running_or_in_review: int | None = Field(None, alias="future_limit_on_ads_running_or_in_review")
    limit_on_ads_running_or_in_review: int | None = Field(None, alias="limit_on_ads_running_or_in_review")
