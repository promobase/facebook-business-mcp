...
class LeadGenFormPreviewDetailsFields(BaseModel):
    ...
    creatives_overview_default_text: str | None = Field(None, alias="creatives_overview_default_text")
    ...
    data_privacy_policy_setting_description: str | None = Field(None, alias="data_privacy_policy_setting_description")
    default_appointment_scheduling_inline_context: str | None = Field(None, alias="default_appointment_scheduling_inline_context")
    default_disqualified_end_component: dict[str, Any] | None = Field(None, alias="default_disqualified_end_component")
    default_thank_you_page: dict[str, Any] | None = Field(None, alias="default_thank_you_page")
    disqualified_thank_you_card_transparency_info_text: str | None = Field(None, alias="disqualified_thank_you_card_transparency_info_text")
    ...
    email_messenger_push_opt_in_disclaimer: str | None = Field(None, alias="email_messenger_push_opt_in_disclaimer")
    email_messenger_push_opt_in_transparency_text: str | None = Field(None, alias="email_messenger_push_opt_in_transparency_text")
    form_clarity_description_content: str | None = Field(None, alias="form_clarity_description_content")
    ...
    gated_content_locked_description: str | None = Field(None, alias="gated_content_locked_description")
    gated_content_locked_headline: str | None = Field(None, alias="gated_content_locked_headline")
    gated_content_unlocked_description: str | None = Field(None, alias="gated_content_unlocked_description")
    gated_content_unlocked_headline: str | None = Field(None, alias="gated_content_unlocked_headline")
    how_it_works_section_headers: list[dict[str, str]] | None = Field(None, alias="how_it_works_section_headers")
    ...
    phone_number_inline_context_text: str | None = Field(None, alias="phone_number_inline_context_text")
    privacy_policy_link_text: str | None = Field(None, alias="privacy_policy_link_text")
    privacy_policy_link_text_for_optional_privacy_policy: str | None = Field(None, alias="privacy_policy_link_text_for_optional_privacy_policy")
    privacy_policy_title_section_title_text: str | None = Field(None, alias="privacy_policy_title_section_title_text")
    privacy_setting_description: str | None = Field(None, alias="privacy_setting_description")
    products_section_headers: list[dict[str, str]] | None = Field(None, alias="products_section_headers")
    qualified_thank_you_card_transparency_info_text: str | None = Field(None, alias="qualified_thank_you_card_transparency_info_text")
    ...
    secure_sharing_text_for_optional_privacy_policy: str | None = Field(None, alias="secure_sharing_text_for_optional_privacy_policy")
    slide_to_submit_text: str | None = Field(None, alias="slide_to_submit_text")
    social_proof_section_headers: list[dict[str, str]] | None = Field(None, alias="social_proof_section_headers")
