...
class CampaignFields(BaseModel):
    ...
    advantage_state_info: dict[str, Any] | None = Field(None, alias="advantage_state_info")
    ...
    brand_lift_studies: list[dict[str, Any]] | None = Field(None, alias="brand_lift_studies")
    ...
    source_campaign: dict[str, Any] | None = Field(None, alias="source_campaign")
