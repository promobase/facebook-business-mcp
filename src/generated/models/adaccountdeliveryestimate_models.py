...
class AdAccountDeliveryEstimateOptimizationGoal(str, Enum):
    """Enum for AdAccountDeliveryEstimate.OptimizationGoal."""
...
class AdAccountDeliveryEstimateFields(BaseModel):
    ...
    daily_outcomes_curve: list[dict[str, Any]] | None = Field(None, alias="daily_outcomes_curve")
