...
class AdAssetFeedSpecFields(BaseModel):
    ...
    additional_data: dict[str, Any] | None = Field(None, alias="additional_data")
    app_product_page_id: str | None = Field(None, alias="app_product_page_id")
    asset_customization_rules: list[dict[str, Any]] | None = Field(None, alias="asset_customization_rules")
    ...
    call_to_actions: list[dict[str, Any]] | None = Field(None, alias="call_to_actions")
    captions: list[dict[str, Any]] | None = Field(None, alias="captions")
    carousels: list[dict[str, Any]] | None = Field(None, alias="carousels")
    ...
    events: list[dict[str, Any]] | None = Field(None, alias="events")
    groups: list[dict[str, Any]] | None = Field(None, alias="groups")
    images: list[dict[str, Any]] | None = Field(None, alias="images")
    link_urls: list[dict[str, Any]] | None = Field(None, alias="link_urls")
    message_extensions: list[dict[str, Any]] | None = Field(None, alias="message_extensions")
    onsite_destinations: list[dict[str, Any]] | None = Field(None, alias="onsite_destinations")
    ...
    videos: list[dict[str, Any]] | None = Field(None, alias="videos")
