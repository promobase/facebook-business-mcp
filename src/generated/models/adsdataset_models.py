...
class AdsDatasetFields(BaseModel):
    ...
    enable_auto_assign_to_accounts: bool | None = Field(None, alias="enable_auto_assign_to_accounts")
    ...
    has_catalog_microdata_activity: bool | None = Field(None, alias="has_catalog_microdata_activity")
    ...
    is_eligible_for_sharing_to_ad_account: bool | None = Field(None, alias="is_eligible_for_sharing_to_ad_account")
    is_eligible_for_sharing_to_business: bool | None = Field(None, alias="is_eligible_for_sharing_to_business")
    is_eligible_for_value_optimization: bool | None = Field(None, alias="is_eligible_for_value_optimization")
    ...
    late_upload_reminder_eligibility: bool | None = Field(None, alias="late_upload_reminder_eligibility")
    ...
    no_ads_tracked_for_weekly_uploaded_events_reminder_eligibility: bool | None = Field(None, alias="no_ads_tracked_for_weekly_uploaded_events_reminder_eligibility")
    num_active_ad_set_tracked: int | None = Field(None, alias="num_active_ad_set_tracked")
    num_recent_offline_conversions_uploaded: int | None = Field(None, alias="num_recent_offline_conversions_uploaded")
    num_uploads: int | None = Field(None, alias="num_uploads")
    owner_ad_account: dict[str, Any] | None = Field(None, alias="owner_ad_account")
    owner_business: dict[str, Any] | None = Field(None, alias="owner_business")
    percentage_of_late_uploads_in_external_suboptimal_window: int | None = Field(None, alias="percentage_of_late_uploads_in_external_suboptimal_window")
    permissions: dict[str, Any] | None = Field(None, alias="permissions")
    ...
    usage: dict[str, Any] | None = Field(None, alias="usage")
