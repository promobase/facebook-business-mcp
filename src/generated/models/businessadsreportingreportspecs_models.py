...
class BusinessAdsReportingReportSpecsFields(BaseModel):
    ...
    business_asset_group: dict[str, Any] | None = Field(None, alias="business_asset_group")
    ...
    last_access_by: dict[str, Any] | None = Field(None, alias="last_access_by")
    ...
    last_shared_report_expiration: datetime | None = Field(None, alias="last_shared_report_expiration")
    ...
    report_snapshot_async_percent_completion: int | None = Field(None, alias="report_snapshot_async_percent_completion")
    ...
    update_by: dict[str, Any] | None = Field(None, alias="update_by")
