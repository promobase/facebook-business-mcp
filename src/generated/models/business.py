...
class BusinessFields(BaseModel):
    ...
    block_offline_analytics: bool = Field(None, alias="block_offline_analytics")
    collaborative_ads_managed_partner_business_info: ManagedPartnerBusinessFields = Field(
        None, alias="collaborative_ads_managed_partner_business_info"
    )
    collaborative_ads_managed_partner_eligibility: BusinessManagedPartnerEligibilityFields = Field(
        None, alias="collaborative_ads_managed_partner_eligibility"
    )
    collaborative_ads_partner_premium_options: BusinessPartnerPremiumOptionsFields = Field(
    ...
    extended_updated_time: datetime = Field(None, alias="extended_updated_time")
    id: str = Field(None, alias="id")
    is_hidden: bool = Field(None, alias="is_hidden")
    link: str = Field(None, alias="link")
    name: str = Field(None, alias="name")
    payment_account_id: str = Field(None, alias="payment_account_id")
    primary_page: PageFields = Field(None, alias="primary_page")
    profile_picture_uri: str = Field(None, alias="profile_picture_uri")
    timezone_id: int = Field(None, alias="timezone_id")
    two_factor_type: str = Field(None, alias="two_factor_type")
    ...
    vertical_id: int = Field(None, alias="vertical_id")
...
class BusinessCreateAccessTokenParams(BaseModel):
    ...
    scope: list[dict[str, Any]] | None = Field(None, description="scope parameter")
...
class BusinessCreateAdStudieParams(BaseModel):
    ...
    type: businessad_studies_type_enum_param | None = Field(None, description="type parameter")
...
class BusinessCreateAdAccountParams(BaseModel):
    ...
    end_advertiser: dict[str, Any] | None = Field(None, description="end_advertiser parameter")
...
class BusinessGetAdNetworkanalyticsParams(BaseModel):
    ...
    breakdowns: list[businessadnetworkanalytics_breakdowns_enum_param] | None = Field(
    ...
    metrics: list[businessadnetworkanalytics_metrics_enum_param] | None = Field(
        None, description="metrics parameter"
    )
    ordering_column: businessadnetworkanalytics_ordering_column_enum_param | None = Field(
        None, description="ordering_column parameter"
    )
    ordering_type: businessadnetworkanalytics_ordering_type_enum_param | None = Field(
...
class BusinessGetAdsDatasetParams(BaseModel):
    ...
    sort_by: businessads_dataset_sort_by_enum_param | None = Field(
...
class BusinessGetAdSpixelsParams(BaseModel):
    ...
    id_filter: str | None = Field(None, description="id_filter parameter")
    name_filter: str | None = Field(None, description="name_filter parameter")
    sort_by: businessadspixels_sort_by_enum_param | None = Field(
        None, description="sort_by parameter"
    )
...
class BusinessGetBusinessInvoicesParams(BaseModel):
    ...
    type: businessbusiness_invoices_type_enum_param | None = Field(
...
class BusinessCreateBusinessUserParams(BaseModel):
    ...
    invited_user_type: list[businessbusiness_users_invited_user_type_enum_param] | None = Field(
        None, description="invited_user_type parameter"
    )
    role: businessbusiness_users_role_enum_param | None = Field(None, description="role parameter")
    tasks: list[businessbusiness_users_tasks_enum_param] | None = Field(
...
class BusinessCreateClientAppParams(BaseModel):
    ...
    model_config = ConfigDict(extra="forbid")
    app_id: dict[str, Any] | None = Field(None, description="app_id parameter")
...
class BusinessCreateClientPageParams(BaseModel):
    ...
    permitted_tasks: list[businessclient_pages_permitted_tasks_enum_param] | None = Field(
...
class BusinessCreateCollaborativeAdsCollaborationRequestParams(BaseModel):
    ...
    requester_agency_or_brand: (
        businesscollaborative_ads_collaboration_requests_requester_agency_or_brand_enum_param | None
    ) = Field(None, description="requester_agency_or_brand parameter")
...
class BusinessCreateCustomConversionParams(BaseModel):
    ...
    model_config = ConfigDict(extra="forbid")
    action_source_type: businesscustomconversions_action_source_type_enum_param | None = Field(
        None, description="action_source_type parameter"
    )
    advanced_rule: str | None = Field(None, description="advanced_rule parameter")
    custom_event_type: businesscustomconversions_custom_event_type_enum_param | None = Field(
...
class BusinessCreateImageParams(BaseModel):
    ...
    name: str | None = Field(None, description="name parameter")
    validation_ad_placements: list[businessimages_validation_ad_placements_enum_param] | None = (
        Field(None, description="validation_ad_placements parameter")
    )
...
class BusinessGetInitiatedAudienceSharingRequestsParams(BaseModel):
    ...
    request_status: businessinitiated_audience_sharing_requests_request_status_enum_param | None = (
        Field(None, description="request_status parameter")
    )
...
class BusinessCreateManagedBusinesseParams(BaseModel):
    ...
    timezone_id: businessmanaged_businesses_timezone_id_enum_param | None = Field(
        None, description="timezone_id parameter"
    )
    vertical: businessmanaged_businesses_vertical_enum_param | None = Field(
...
class BusinessCreateManagedPartnerBusinesseParams(BaseModel):
    ...
    ) = Field(None, description="survey_business_type parameter")
    survey_num_assets: int | None = Field(None, description="survey_num_assets parameter")
    survey_num_people: int | None = Field(None, description="survey_num_people parameter")
    timezone_id: businessmanaged_partner_businesses_timezone_id_enum_param | None = Field(
        None, description="timezone_id parameter"
    )
    vertical: businessmanaged_partner_businesses_vertical_enum_param | None = Field(
        None, description="vertical parameter"
    )
...
class BusinessCreateOwnedBusinesseParams(BaseModel):
    ...
    name: str | None = Field(None, description="name parameter")
    page_permitted_tasks: list[businessowned_businesses_page_permitted_tasks_enum_param] | None = (
        Field(None, description="page_permitted_tasks parameter")
    )
    sales_rep_email: str | None = Field(None, description="sales_rep_email parameter")
    ...
    survey_num_assets: int | None = Field(None, description="survey_num_assets parameter")
    survey_num_people: int | None = Field(None, description="survey_num_people parameter")
    timezone_id: businessowned_businesses_timezone_id_enum_param | None = Field(
        None, description="timezone_id parameter"
    )
    vertical: businessowned_businesses_vertical_enum_param | None = Field(
        None, description="vertical parameter"
    )
...
class BusinessCreateOwnedProductCatalogParams(BaseModel):
    ...
    ) = Field(None, description="additional_vertical_option parameter")
    business_metadata: dict[str, Any] | None = Field(
        None, description="business_metadata parameter"
    )
    catalog_segment_filter: dict[str, Any] | None = Field(
        None, description="catalog_segment_filter parameter"
    )
    catalog_segment_product_set_id: str | None = Field(
        None, description="catalog_segment_product_set_id parameter"
    )
    da_display_settings: dict[str, Any] | None = Field(
        None, description="da_display_settings parameter"
    )
    ...
    vertical: businessowned_product_catalogs_vertical_enum_param | None = Field(
        None, description="vertical parameter"
    )
...
class BusinessGetPictureParams(BaseModel):
    ...
    type: businesspicture_type_enum_param | None = Field(None, description="type parameter")
...
class BusinessCreateSelfCertifyWhatsappBusineParams(BaseModel):
    ...
    business_documents: list[dict[str, Any]] | None = Field(
        None, description="business_documents parameter"
    )
    business_vertical: (
        businessself_certify_whatsapp_business_business_vertical_enum_param | None
    ) = Field(None, description="business_vertical parameter")
...
class BusinessCreateSetupManagedPartnerAdaccountParams(BaseModel):
    ...
    subvertical_v2: businesssetup_managed_partner_adaccounts_subvertical_v2_enum_param | None = (
        Field(None, description="subvertical_v2 parameter")
    )
    vendor_id: str | None = Field(None, description="vendor_id parameter")
    vertical_v2: businesssetup_managed_partner_adaccounts_vertical_v2_enum_param | None = Field(
        None, description="vertical_v2 parameter"
    )
...
class BusinessCreateSystemUserParams(BaseModel):
    ...
    model_config = ConfigDict(extra="forbid")
    name: str | None = Field(None, description="name parameter")
    role: businesssystem_users_role_enum_param | None = Field(None, description="role parameter")
    system_user_id: int | None = Field(None, description="system_user_id parameter")
...
class BusinessCreateVideoParams(BaseModel):
    ...
    container_type: businessvideos_container_type_enum_param | None = Field(
        None, description="container_type parameter"
    )
    content_category: businessvideos_content_category_enum_param | None = Field(
    ...
    formatting: businessvideos_formatting_enum_param | None = Field(
    ...
    swap_mode: businessvideos_swap_mode_enum_param | None = Field(
    ...
    upload_phase: businessvideos_upload_phase_enum_param | None = Field(
    ...
    validation_ad_placements: list[businessvideos_validation_ad_placements_enum_param] | None = (
        Field(None, description="validation_ad_placements parameter")
    )
