...
class AdReportRunFields(BaseModel):
    ...
    action_attribution_windows: list[dict[str, Any]] | None = Field(None, alias="action_attribution_windows")
    ...
    summary_action_breakdowns: list[dict[str, Any]] | None = Field(None, alias="summary_action_breakdowns")
    ...
    use_account_attribution_setting: bool | None = Field(None, alias="use_account_attribution_setting")
    use_unified_attribution_setting: bool | None = Field(None, alias="use_unified_attribution_setting")
