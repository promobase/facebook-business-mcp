...
class BrandedContentShadowIGMediaIDFields(BaseModel):
    ...
    has_permission_for_partnership_ad: bool | None = Field(None, alias="has_permission_for_partnership_ad")
    id: str | None = Field(None, alias="id")
    owner_id: str | None = Field(None, alias="owner_id")
    permalink: str | None = Field(None, alias="permalink")
    recommended_campaign_objectives: list[str] | None = Field(None, alias="recommended_campaign_objectives")
