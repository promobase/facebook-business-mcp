...
class AdAccountDefaultObjectiveFields(BaseModel):
    ...
    default_objective_for_user: dict[str, Any] = Field(None, alias="default_objective_for_user")
    objective_for_level: dict[str, Any] = Field(None, alias="objective_for_level")
