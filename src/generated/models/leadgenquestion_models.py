...
class LeadGenQuestionFields(BaseModel):
    ...
    conditional_questions_choices: list[dict[str, Any]] | None = Field(None, alias="conditional_questions_choices")
    conditional_questions_group_id: str | None = Field(None, alias="conditional_questions_group_id")
    dependent_conditional_questions: list[dict[str, Any]] | None = Field(None, alias="dependent_conditional_questions")
    ...
    options: list[dict[str, Any]] | None = Field(None, alias="options")
