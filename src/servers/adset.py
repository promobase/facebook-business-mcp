...
@adset_server.tool
def get_campaign_adsets(campaign_id: str, limit: int = 25) -> AdSetResponse | ErrorResponse:
    ...
    Returns:
        List of ad sets with comprehensive fields
    """
    try:
        ...
        adsets_list = [dict(adset) for adset in adsets]
        return {"success": True, "data": adsets_list}
